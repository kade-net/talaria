...
var TalariaServiceService = exports.TalariaServiceService = {
  getTalariaEvent: {
    path: '/TalariaService/GetTalariaEvent',
    requestStream: false,
  ...
  getTalariaEvents: {
    path: '/TalariaService/GetTalariaEvents',
    requestStream: false,
    responseStream: true,
...
exports.TalariaServiceClient = grpc.makeGenericClientConstructor(TalariaServiceService);
